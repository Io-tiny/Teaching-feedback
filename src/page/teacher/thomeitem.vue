...
export default {
  ...
  methods: {
    getItemData: function() {
      ...
      this.pagesize = 5;
      this.$http
        .post("http://localhost:3000/api/item/getHomeData", {})
    ...
    saveItemData: function(itemData) {
      ...
      if (this.itemData.id) {
        this.$http
          .post("http://localhost:3000/api/item/updateHomeData", {
            id: self.itemData.id,
    ...
    delItemData: function(index, row) {
      self = this;
      this.$http
        .post("http://localhost:3000/api/item/delHomeData", {
          id: row.id
        })
        .then(function(response) {
          self.getItemData();
    ...
    addItemData: function() {
      ...
      self = this;
      this.$http
        .post("http://localhost:3000/api/item/addHomeData", {
          name: self.itemData.name,
          section: self.itemData.section,
          answer: self.itemData.answer,
          sort: self.itemData.sort,
