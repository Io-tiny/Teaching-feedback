    ...
    <div class="info"> 
      <el-form ref="info" :model="info" :rules="loginRules" label-width="90px" style="width: 50%; margin-top: 40px">
        <el-form-item label="用户名" prop="username">
          <el-input ref="username" v-model="info.username"></el-input>
        </el-form-item>
        <el-form-item label="密码" prop="password">
          <el-input ref="password" v-model="info.password" show-password></el-input>
        </el-form-item>
        <el-form-item label="姓名" prop="name">
          <el-input ref="name" v-model="info.name"></el-input>
        </el-form-item>
        <el-form-item label="手机号" prop="phone">
          <el-input ref="phone" v-model="info.phone"></el-input>
        </el-form-item>
        <el-form-item label="邮箱号" prop='email'>
          <el-input ref="email" v-model="info.email"></el-input>
        </el-form-item>
        <el-form-item label="管理班级">
          <el-input v-model="info.class" placeholder="如果有多个请用','隔开"></el-input>
        </el-form-item>
    ...
    getinfo: function() {
      ...
      this.$http
        ...
        .then(function(response) {
          ...
          localStorage.setItem("name",self.info.name);
        })
